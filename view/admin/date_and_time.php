...
<select id="<?php echo esc_attr( $name ) ?>_day" name="<?php echo esc_attr( $name ) ?>_day">
	<?php for ($x = 1; $x < 32; $x++) : ?>
	<option value="<?php echo esc_attr( $x ); ?>" <?php if ($x == $current_day) echo 'selected="selected"' ?>><?php echo $x ?></option>
	<?php endfor; ?>
</select>

<select id="<?php echo esc_attr( $name ) ?>_year" name="<?php echo esc_attr( $name ) ?>_year">
	<?php for ($x = 2006; $x < 2020; $x++) : ?>
	<option value="<?php echo esc_attr( $x ); ?>" <?php if ($x == $current_year) echo 'selected="selected"' ?>><?php echo $x ?></option>
	<?php endfor; ?>
</select>
