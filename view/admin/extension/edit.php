	...
	<table class="edit_filter" width="100%">
  	...
  	<tr>
			...
			<td>
				...
				<input class="button-secondary" type="button" name="cancel" value="Cancel" onclick="show_extension (<?php echo intval( $extension->id ) ?>,'<?php echo esc_attr( $extension->what_group () ) ?>'); return false"/>
			</td>
		</tr>
	</table>
</form>
